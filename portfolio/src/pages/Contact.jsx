          ...
          <div className="grid md:grid-cols-2 gap-x-12 gap-y-8 items-start">
                  ...
                  {socials.map((s) => {
                    ...
                    return (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className={`${linkClass} bg-primary/5 border-primary/20 text-primary hover:bg-primary hover:text-primary-foreground transition-all font-semibold`}
                      >
                        <Icon size={18} />
                        {s.label}
                      </a>
            ...
            <Reveal width="100%" delay={0.5}>
              <form
                ...
                className="bg-card border border-divider rounded-2xl p-6 md:p-8 shadow-sm space-y-5"
              >
                {errorMsg && (
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 py-4 bg-primary hover:bg-primary-hover text-primary-foreground rounded-xl text-base font-bold transition-all shadow-xl shadow-primary/20 hover:shadow-primary/30 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {loading ? (
